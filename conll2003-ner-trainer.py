...
if __name__ == '__main__':
    ...
    parser.add_argument( '--model_name', type = str, default = 'hopeless' )
    ...
    mention_net.tofile( 'conll2003-model/' + args.model_name )
    ...
    conll2003_gazetteer = gazetteer( args.data_path + '/ner-list' )
    ...
    for n_epoch in xrange( config.max_iter ):
        ...
        valid_predicted = open( 'conll2003-result/conll2003-valid.predicted', 'wb' )
        test_predicted = open( 'conll2003-result/conll2003-test.predicted', 'wb' )
        ...
        cmd = ('python CoNLL2003eval.py --threshold=%f --algorithm=%d --n_window=%d ' \
        ...
        logger.info( 'BEST SO FOR: threshold %f, algorithm %s\n' % \
                        ( mention_net.config.threshold, 
                          algo_list[mention_net.config.algorithm - 1]) + best_test_info )
